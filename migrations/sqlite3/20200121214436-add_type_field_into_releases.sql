-- +migrate Up
ALTER TABLE "releases" ADD "type" VARCHAR(20) DEFAULT "album";
...
-- +migrate StatementBegin
INSERT INTO "temp_releases" (id,created_at,artist_id,title,poster,released,store_name,store_id)
SELECT id,created_at,artist_id,title,poster,released,store_name,store_id FROM releases;
-- +migrate StatementEnd
